...
class red_cvpi_06_pu_sheriff;
class amityrp_v_CrownVictoria06_uc_base : red_cvpi_06_pu_sheriff
{
	terrainCoef = 1.7;
	turnCoef = 2.0;
	precision = 12;
...
class amityrp_v_CrownVictoria06_PD011 : amityrp_v_CrownVictoria06_uc_base
{
	displayName = "Crown Victoria 2006";
	hiddenSelectionsTextures[] = {"#(argb,8,8,3)color(0.093,0.093,0.093,1,CO)"};
	peakTorque = 450;
};

class amityrp_v_CrownVictoria06_PD012 : amityrp_v_CrownVictoria06_uc_base
{
	displayName = "Crown Victoria 2006";
