...
class red_taurus_10_p_u_sheriff;
class amityrp_v_FordTaurus_uc_base : red_taurus_10_p_u_sheriff
{
	terrainCoef = 1.7;
	turnCoef = 2.0;
	precision = 15;
...
class amityrp_v_FordTaurus_PD028 : amityrp_v_FordTaurus_uc_base
{
	displayName = "Ford Taurus 2010";
