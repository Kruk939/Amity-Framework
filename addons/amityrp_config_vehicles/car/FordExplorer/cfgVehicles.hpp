...
class red_explorer_16_p_u_sheriff;
class amityrp_v_FordExplorer_uc_base : red_explorer_16_p_u_sheriff
{
	terrainCoef = 1.7;
	turnCoef = 2.0;
	precision = 15;
...
{
	displayName = "Ford Explorer 2017 PD019";
...
{
	displayName = "Ford Explorer 2017 SWAT020";
...
{
	displayName = "Ford Explorer 2017 PD021";
	hiddenSelectionsTextures[] = {"\amityrp_data_vehicles\textures\cars\FordExplorer\ford_explorer_021.paa","","","","","","","","","","","","","","","","","","","","","","",""};
};

class amityrp_v_FordExplorer_PD022 : amityrp_v_FordExplorer_uc_base
{
	displayName = "Ford Explorer 2017";
	hiddenSelectionsTextures[] = {"#(argb,8,8,3)color(0,0,0.2,1,CO)"};
};

class amityrp_v_FordExplorer_PD023 : amityrp_v_FordExplorer_uc_base
{
	displayName = "Ford Explorer 2017";
	hiddenSelectionsTextures[] = {"#(argb,8,8,3)color(0.9,0.9,0.9,1,CO)"};
};
