...
if(_type == "LB") then {
      if((count _data) != 0) then {
            _data params["_id", "_profile_id", "_faction_id", "_vehicle_id", "_class", "_vin", "_plate", "_status", "_hit", "_damage", "_fuel", "_color", "_material", "_rims", "_lights", "_position", "_inventory", "_access_level"];
