...
if((count _garage) != 0) then {
      ...
      {
            _x params["_id", "_profile_id", "_faction_id", "_vehicle_id", "_class", "_vin", "_plate", "_status", "_hit", "_damage", "_fuel", "_color", "_material", "_rims", "_lights", "_position", "_inventory", "_access_level"];
