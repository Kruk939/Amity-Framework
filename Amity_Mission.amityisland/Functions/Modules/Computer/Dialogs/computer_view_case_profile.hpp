class computer_view_case_profile {
      ...
      class controls {
		...
		class button_save: RscButton {
			idc = 1600;
                  action = " ['SAVE'] call ClientModules_Computer_fnc_computer_view_case_profile_action; ";
		...
		class button_close_case: RscButton {
			idc = 1601;
                  action = " ['CLOSE'] call ClientModules_Computer_fnc_computer_view_case_profile_action; ";
