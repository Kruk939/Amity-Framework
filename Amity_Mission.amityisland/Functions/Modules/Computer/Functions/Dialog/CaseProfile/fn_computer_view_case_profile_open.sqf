...
private _ok = createDialog "computer_view_case_profile";
if(!_ok) exitWith {};
...
if(count _data != 0) then {
      [_this, "ClientModules_Computer_fnc_computer_view_case_profile_open"] call ClientModules_Computer_fnc_addLast;
