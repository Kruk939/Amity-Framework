...
[_holder, 2, false] call Client_fnc_lock;

private _shops = getArray(_config >> "Setup" >> "shops");
private _shop = _shops call BIS_fnc_selectRandom;
[_holder, _shop, false, [getNumber(_config >> "Setup" >> "Random" >> "min"), getNumber(_config >> "Setup" >> "Random" >> "max")]] remoteExec["ServerModules_Shop_fnc_addRandomItemsFormShopToCargo", 2];
